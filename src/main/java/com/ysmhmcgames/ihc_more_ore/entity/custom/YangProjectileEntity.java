...
public class YangProjectileEntity extends AbstractArrow {
    public YangProjectileEntity(EntityType<? extends AbstractArrow> entityType, Level level) {
        super(entityType, level);
    }

    public YangProjectileEntity(LivingEntity shooter, Level level){
        super(HCEntities.YANG_ARROW.get(), shooter, level, new ItemStack(HCTools.YANG_ARROW.get()), new ItemStack(HCTools.POLE_BOW.get()));
    }

    @Override
    protected ItemStack getDefaultPickupItem() {
        return new ItemStack(HCTools.YANG_ARROW.get());
    }
